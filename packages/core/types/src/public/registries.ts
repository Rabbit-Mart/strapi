...
export interface Controllers {
  [uid: UID.Controller]: Core.Controller;
}
...
export interface Middlewares {
  [uid: UID.Middleware]: Core.Middleware;
}
...
export interface ContentTypesSchemas {
  'api::car.car': {
    ...
    attributes: {
      name: { type: 'string' };
      brand: Schema.Attribute.OneToMany<'api::post.post'>;
      cp: Schema.Attribute.Component<'default.comp'>;
    };
  };
  ...
  'api::post.post': {
    ...
    attributes: {
      ...
      views: { type: 'float' };
      dz: Schema.Attribute.DynamicZone<['default.comp', 'default.other']>;
    };
  };
}
...
export interface ComponentsSchemas {
  ...
  'default.other': {
    ...
    attributes: {
      another: Schema.Attribute.BigInteger & Schema.Attribute.DefaultTo<'2'>;
    };
  };
}
