...
import type { Entity, Component } from '@strapi/types/data';
import type * as Utils from '@strapi/types/utils';
import type * as Schema from '@strapi/types/schema';

type LoadedComponents<TUID extends UID.Schema> = Entity<
  TUID,
...
>(
  ...
  for (const attributeName of attributeNames) {
    ...
    if (attribute.type === 'component') {
      ...
      if (repeatable === true) {
        ...
        const component = await createComponent(
          componentUID,
          componentValue as EntityService.Params.Data.Input<UID.Component>
        );
    ...
    if (attribute.type === 'dynamiczone') {
      ...
      ] as EntityService.Params.Attribute.GetValue<Schema.Attribute.DynamicZone>;
...
const deleteComponents = async <TUID extends UID.Schema, TEntity extends Entity<TUID>>(
  uid: TUID,
...
const deleteComponent = async <TUID extends UID.Component>(
  uid: TUID,
  componentToDelete: Component<TUID>
) => {
