 ...
 */
const isLastSuperAdminUser = async (userId: ID): Promise<boolean> => {
 ...
 * Find one user
 */
const findOne = async (id: ID, populate = ['roles']) => {
 ...
 */
const deleteById = async (id: ID): Promise<AdminUser | null> => {
  // Check at least one super admin remains
 ...
 */
const assignARoleToAll = async (roleId: ID): Promise<void> => {
